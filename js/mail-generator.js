...
//2
  function loadGeeMails(){
    for (var i = 0; i < 10; i++){ //for loop running through all 10 data types in the arrays aboce in section 1
      var message = generateMessage(); //empty function, defined in section 3
      window.geemails.push(message); //pushing each of the 10 data sets into the window "geemails"
    }
  }//loadGeeMails function runs a for loop
  //new variable: message
  //new function (created below): generateMessage
